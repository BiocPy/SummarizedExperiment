...
`SummarizedExperiment` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/SummarizedExperiment
[issue tracker]: https://github.com/<USERNAME>/SummarizedExperiment/issues
