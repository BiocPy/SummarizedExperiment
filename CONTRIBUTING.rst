...
Welcome to ``SummarizedExperiment`` contributor's guide.
...
If you experience bugs or general issues with ``SummarizedExperiment``, please have a look
...
You can help improve ``SummarizedExperiment`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``SummarizedExperiment`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``SummarizedExperiment``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n SummarizedExperiment python=3 six virtualenv pytest pytest-cov
    conda activate SummarizedExperiment
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/SummarizedExperiment.git
...
#. Install |pre-commit|_::
   ...
   ``SummarizedExperiment`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/SummarizedExperiment
.. _issue tracker: https://github.com/<USERNAME>/SummarizedExperiment/issues
.. <-- end -->
